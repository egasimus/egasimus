...
|![](https://img.shields.io/github/created-at/egasimus/hfedisk?color=123&label=)|![](https://img.shields.io/github/last-commit/egasimus/hfedisk?color=123&label=)|[hfedisk](https://github.com/egasimus/hfedisk)|**Rust.** Partial implementation of HFE disk image format for Gotek HxC floppy emulator.|
|![](https://img.shields.io/github/created-at/egasimus/laterna?color=123&label=)|![](https://img.shields.io/github/last-commit/egasimus/laterna?color=123&label=)|[laterna](https://github.com/egasimus/laterna)|**Rust.** Renders piano rolls to the terminal.|
